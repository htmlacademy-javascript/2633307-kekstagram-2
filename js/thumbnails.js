// Модуль отрисовки миниатюр фотографий на главной странице
import { onBigPictureOpen } from './big-picture-handler.js';

// Создание одного DOM‑элемента миниатюры по данным фотографии
const createPictureElement = (photoData) => {
  ...
  pictureElement.addEventListener('click', (evt) => {
    evt.preventDefault();
    onBigPictureOpen(photoData);
  });

  return pictureElement;
};

// Отрисовка списка миниатюр в контейнере: очистка и заполнение заново
